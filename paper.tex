...
We start with the structure of pristine phoshorene, Fig. \ref{..}a. A B3LYP-D3 optimization gaves the lattice parameters of  $a=3.3\AA$ and  $b=4.47\AA$ (the exact specification is in given the SI). Introduction of the defect 
