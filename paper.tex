...
A B3LYP-D3 optimization of pristine phoshorene, Fig. \ref{fig:per_phos}a gives the lattice parameters of  $a=3.3\AA$ and  $b=4.47\AA$ (the exact structural specification is in given the SI). Introduction of a vacancy in phosphorene, i.e. removal of a phosphorus atom, leads to a structural reconstruction of the neighboring atoms. Two reconstructed monovacancy structures are typically considered in phosphorene: the asymmetric (5|9) and the symmetric (55|66) configurations denoted by the number of the atoms forming the rings. To probe both In our optimizations we used symmetric and and symmetry dBroken-symmetry B3LYP-D3 optimizations for the triplet statriplet We performed optimizations using n-polarized  DFT for singlet 
