...
We begin by analyzing the Hartree-Foc contribution $\Delta E^{\rm ADM}({\rm HF})$ to the defect formation energy, shown in Fig.~\ref{fig:En_form} (the numerical values are provided in the Supporting Information). 
...
This moderate formation energy indicates that vacancy formation in phosphorene is  energetically accessible, suggesting that such defects can form under realistic conditions, in agreement with previous studies. 
The present value lies at the lower end of the range obtained from DFT studies for neutral vacancies.\cite{Hu2015_PhosphoreneVacancies,Naik2020_PRMaterials_PhosphoreneDefects,Rijal2021_PhosphoreneVacancy} In contrast, our benchmark refers to the negatively charged defect and involves a higher-level treatment of electron correlation.
