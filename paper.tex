...
The present value lies at the lower end of the range obtained from DFT calculations for neutral vacancies (0.9 eV -- 1.7 eV).\cite{Hu2015_PhosphoreneVacancies,Naik2020_PRMaterials_PhosphoreneDefects,Rijal2021_PhosphoreneVacancy} Our benchmark, however, refers to the negatively charged defect and involves a higher-level treatment of electron correlation.
